...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `You are a helpful assistant that finds local medical facilities. Respond with ONLY a valid JSON object that conforms to the following schema:
