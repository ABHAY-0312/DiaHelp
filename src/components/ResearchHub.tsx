...
import { Loader2, Camera, Sparkles, ImageOff, FlaskConical, AlertCircle, FileText, Pill, Lightbulb, NotebookText } from 'lucide-react';
...
export function ResearchHub() {
  ...
  const DocumentUploader = ({ title, description }: { title: string, description: string }) => (
        ...
        <CardContent>
            ...
            <div className="space-y-6">
                ...
                {analysis.extractedFields.length > 0 && (
                    <div>
                    <h4 className="font-semibold text-lg mb-2 flex items-center gap-2"><NotebookText className="w-5 h-5"/> Extracted Lab Results</h4>
    ...
    <div className="space-y-4">
        <div className="flex items-center gap-4">
            ...
            <div>
                ...
                <p className="text-muted-foreground">Advanced AI tools for document analysis.</p>
            </div>
        </div>
         <Alert>
        ...
        <Tabs defaultValue="lab_report" className="w-full">
            <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="lab_report">Blood Report Reader</TabsTrigger>
                <TabsTrigger value="prescription">Prescription Reader</TabsTrigger>
            </TabsList>
            <TabsContent value="lab_report">
                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start mt-4">
                    <DocumentUploader title="Blood Report Reader" description="Upload a lab report to extract and interpret data."/>
                    <AnalysisDisplay />
                 </div>
            </TabsContent>
            <TabsContent value="prescription">
                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start mt-4">
                    <DocumentUploader title="Prescription Reader" description="Upload a doctor's prescription to extract medication details."/>
                    <AnalysisDisplay />
                 </div>
            </TabsContent>
        </Tabs>
